...
export class AppTitleBar extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/common/AppTitleBar.ets(10:5)", "entry");
            Row.width('100%');
            Row.height(56);
            ...
            if (this.showBack) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/components/common/AppTitleBar.ets(13:9)", "entry");
                        Button.width(40);
                        Button.height(40);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/components/common/AppTitleBar.ets(14:11)", "entry");
                        Image.width(24);
                        Image.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/common/AppTitleBar.ets(31:7)", "entry");
            // 标题
            Text.fontSize(20);
            // 标题
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.rightIcon) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle });
                        Button.debugLine("entry/src/main/ets/components/common/AppTitleBar.ets(39:9)", "entry");
                        Button.width(40);
                        Button.height(40);
                        Button.backgroundColor('#F5F5F5');
                        Button.onClick(() => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/components/common/AppTitleBar.ets(40:11)", "entry");
                        Image.width(24);
                        Image.height(24);
                        Image.fillColor('#333333');
                    }, Image);
